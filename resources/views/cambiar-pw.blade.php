    ...
    <div class="ibox login-content">
        ...
        <form class="ibox-body pt-0" id="forgot-form" action="javascript:;" method="POST">
            ...
            <div class="form-group mb-4">
             ...
             <div class="form-group mb-4">
                <input class="form-control form-control-line" type="password" name="password_confirmation" placeholder="Repetir contraseña" required="true">
            </div>
            <div class="text-center">
                <button class="btn btn-primary btn-rounded btn-block btn-air" style="background-color: #d81e05; color: white; border-color:#d81e05; ">Enviar</button>
            </div>
        </form>
    </div>
