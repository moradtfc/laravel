...
@section('content')
 <div class="page-heading">
                <h1 class="page-title">Productos Staging</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                         <a href="{{url('/socios/dashboard')}}"><i class="la la-home font-20"></i></a>
                    </li>
                    <li class="breadcrumb-item">Productos</li>
                    <li class="breadcrumb-item">Listado productos staging</li>
                </ol>
</div>
                            ...
                            <table class="table table-bordered table-hover" id="datatablex">
                                ...
                                <tbody>
                                	@foreach($productos as $item)
                                      <tr>
										   	<td><a href="{{url('/scotiabank/producto/detalle_producto/'.$item->id)}}">{{ $item->name }} </a></td>
