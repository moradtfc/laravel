                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="ibox ibox-fullheight">
                            ...
                            <form class="form-info" enctype="multipart/form-data" action="{{ url('/registrar-productos') }}" method="post">
                            	@csrf
                                <div class="ibox-body">
 @if(session()->has('msj'))
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group mb-4">
                                             <label>¿Es licor?</label>
                                                <select class="form-control select2_demo_1" name="es_licor">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="file" name="imgpro" required>
                                    </label>
                                        </div>
