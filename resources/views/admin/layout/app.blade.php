                ...
                <ul class="side-menu">
                    <li class="active">
                        ...
                        <div class="nav-2-level">
                            <ul>
                                <li>
                                    <a href="{{ url('/listado-productos') }}">Todos</a>
                                </li>
                                <li>
                                    <a href="{{ url('/registro-productos') }}">Agregar nuevo</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="nav-2-level">
                            <ul>
                                <li>
                                    <a href="{{ url('/listado-categoria') }}">Todas</a>
                                </li>
                                <li>
                                    <a href="{{ url('/registro-categoria') }}">Agregar nuevo</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="nav-2-level">
                            <ul>
                                <li>
                                    <a href="{{url('/listado-brand')}}">Todas</a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <div class="nav-2-level">
                            <ul>
                                <li>
                                    <a href="{{url('/listado-store')}}">Todas</a>
                                </li>
                                <li>
                    ...
                    <li>
                        ...
                        <div class="nav-2-level">
                            <ul>
                                <li>
                                <a href="{{ url('/listado-comentarios')}}">Todos</a>
                                </li>
                            </ul>
                        </div>
                    </li>
