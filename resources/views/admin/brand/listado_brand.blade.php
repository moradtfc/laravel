                                ...
                                <tbody>
                                    @foreach($brand as $item)
                                      <tr>
                                            ...
                                            <td><a href="{{url('/perfil-brand/'.$item->id)}}">{{ $item->name }}</a></td>
                                            <td>{{ $item->web }}</td>
                                            <td><a class="text-muted font-16" href=""><i class="ti-user"></i></a>
                                            <a class="text-muted font-16" href=""><i class="ti-trash"></i></a></td>
